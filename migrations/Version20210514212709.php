 ...
 */
final class Version20210514212709 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE color_table');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE color_table (name TEXT DEFAULT NULL)');
